...
| List documents | Dashboard | `GET /api/v1/workspaces/:workspaceId/documents` | `client.docs.list(workspaceId)` | `mdxdoc docs list --workspace <id>` | E2E/API/CLI live smoke | ✅ |
| Create document | New document button / command palette | `POST /api/v1/workspaces/:workspaceId/documents` | `client.docs.create()` | `mdxdoc docs create "Title" --workspace <id>` | E2E/API/CLI live smoke | ✅ |
...
| Safe source push as suggestion | Suggesting mode / propose suggestion | `POST /api/v1/documents/:id/suggestions` | `client.docs.createSuggestion()` | `mdxdoc push <doc> file.mdx` | E2E/API/CLI live smoke | ✅ |
...
| Export source | not yet explicit UI button | `GET /source` currently | `client.docs.source()` | `mdxdoc export <doc> --out file.mdx` | CLI help smoke | 🟡 |
